...
@section('content')
    <div class="container-fluid rounded bg-white p-3">
        ...
        <form class="w-75 mt-3" method="POST" action="{{ route('admin/event.store') }}" autocomplete="off"
