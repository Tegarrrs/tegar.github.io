...
@section('content')
    ...
    <div class="container-fluid rounded bg-white p-3">
        ...
        <a class="btn btn-primary mb-3" href="{{ route('admin/category.create') }}">Tambah Data</a>
                                ...
                                <tr>
                                    ...
                                    <td class="d-flex flex-row justify-content-around m-auto">
                                        <a class="btn btn-primary m-1"
                                            href="{{ route('admin/category.edit', $categories) }}">Edit</a>
                                        <form action="{{ route('admin/category.destroy', $categories) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
